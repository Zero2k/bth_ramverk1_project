    ...
    <div class="container">
        <div class="row text-xs-center text-sm-left text-md-left">
            ...
            <div class="col-xs-12 col-sm-3 col-md-3">
                ...
                <div style="color: #fff">
                    <small><p>coin<b>overflow</b> is a Registered MSP/ISO of WGTOTW, Inc. Code and Design by Viktor Bengtsson (https://github.com/Zero2k)</p></small>
                    <p class="h7">&copy All right Reversed.</p>
                </div>
            </div>
        </div>
        <!-- <div class="row">
